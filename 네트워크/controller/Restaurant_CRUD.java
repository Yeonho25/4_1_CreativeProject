...
public class Restaurant_CRUD implements Initializable {
	...
	{
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/RestaurantReview.fxml"));
			Parent root = (Parent)loader.load();
			
			Scene scene = new Scene(root, 600,580);
			
			Restaurant_Review review = loader.getController();
			
			RestaurantDTO restaurant = new RestaurantDTO();
			restaurant.setId(Integer.parseInt(id.getText()));
			restaurant.setName(name.getText());
			
			review.initData(restaurant);
			
			Stage stage = new Stage();
			stage.initModality(Modality.APPLICATION_MODAL);
			stage.setTitle("Restaurant Review");
